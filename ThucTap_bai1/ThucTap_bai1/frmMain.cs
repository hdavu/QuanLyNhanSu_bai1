...
namespace ThucTap_bai1
{
    public partial class frmMain : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(local)\SQLEXPRESS;Initial Catalog=Quanlinhansu;Integrated Security=True");
        ...
        private void huong_danToolStripMenuItem_Click(object sender, EventArgs e)
        {
